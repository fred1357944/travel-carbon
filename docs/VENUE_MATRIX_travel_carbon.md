...
## 4. 雙論文切割（2026-07-12 使用者拍板方向）

| | **Paper E**（教育／採用） | **Paper S**（永續治理／盤查） |
|--|---------------------------|--------------------------------|
| **主 venue** | **Education and Information Technologies**（Springer 10639） | **IJSHE**（主）／Sustainability（APC 備） |
| **核心 RQ** | 行政數位工具如何被**永續單位採用**？如何進入**永續素養課堂**並增進學生碳識讀？ | free-text 差旅帳冊如何做成可稽核 **Scope 3 Cat.6 距離法**流程？機構意涵？ |
| **理論口味** | EdTech + 組織採用（sociotechnical / adoption）+ 素養課設計 | GHG Protocol / ISO 14064 / HEI CF 文獻 |
| **證據** | 課堂試教＋學生回饋；永續／行政人員訪談或使用日誌 | 去識別年度 ledger、敏感度、未解析率、流程 |
| **系統描述** | 1–1.5 節（教具／邊界物件） | 完整 methods |
| **共用** | 工具存在、公開 repo、合成 demo | 同左 |
| **不可共用當主結果** | 同一班學習成效表 | 同一張機構盤查總表 |

### Paper E 敘事金句（可用於 abstract）

> 本研究將開源差旅碳估算工作流同時定位為（1）大學永續單位可採用的**行政數位工具**，與（2）永續素養學程中可操作的**教學邊界物件**，檢視採用條件、課堂使用與學習回饋。

### 10639 判決更新

| 項目 | 原 as-is | 現 framing |
|------|----------|------------|
| Scope | RED～AMBER | **AMBER→條件 GREEN**（必須有課堂與／或採用證據） |
| 條件 | — | 至少一輪試教 **或** 永續單位使用研究；合成資料上課；倫理寫清 |
